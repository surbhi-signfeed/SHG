...
const ListDepartments: React.FC = () => {
  ...
  const data: SHGData[] = [
    { key: "1", role: "UJSBAN2023_01", Status: "SARASWATI SHG KHARKHADA" },
    { key: "2", role: "UJSSHG2022_01", Status: "VISWASH SHG" },
    { key: "3", role: "UJSSHG2022_02", Status: "MOUSAM SHG" },
    { key: "4", role: "UJSSHG2022_03", Status: "SHALU SHG" },
    { key: "5", role: "UJSSHG2022_04", Status: "MONIKA SHG" },
    { key: "6", role: "UJSSHG2022_05", Status: "JYOTI SHG" },
    { key: "7", role: "UJSSHG2022_06", Status: "MADHU SHG" },
  ];
   // Initialize router
  ...
  const handleEditClick = (record: SHGData) => {
    ...
    router.push("/pages/Departments/UpdateDepartment");
  };
