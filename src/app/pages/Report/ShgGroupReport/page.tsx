...
const exportToExcel = (data: any[]) => {
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, 'ShgGroup');

  // Create an Excel file and trigger the download when user clicks the button
  XLSX.writeFile(workbook, 'ShgGroupReport.xlsx');
};
  return (
    <>
      <TopNavbar />
