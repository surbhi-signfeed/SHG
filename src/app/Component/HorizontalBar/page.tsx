...
const HorizontalBar = () => {
    ...
    return (
        < >
        <div
            className={`hidden lg:flex top-[14vh]  w-full bg-[#2B2F3B] text-white shadow-md z-10 transition-all duration-300 relative`}
        >
            <div className="px-4 py-2">
                <div className="flex overflow-x-auto space-x-4 no-scrollbar">
                    ...
                    <div className="flex items-center space-x-2 cursor-pointer">
                        <MdOutlineHouse />
                        <Link href="/pages/Dashboard" className="no-underline decoration-none text-white">
                            <span>Dashboard</span>
                        </Link>
                    </div>
                    ...
                    <div className=" mt-2">
                        ...
                        {isRolesOpen && (
                            <div className="absolute  mt-2 p-4 bg-gray-700 rounded-md shadow-lg z-20">
                                <Link
